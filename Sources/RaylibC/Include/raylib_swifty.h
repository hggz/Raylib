...
RLAPI void Draw3DBillboardRec(Camera camera, Texture2D texture, Rectangle source, Vector3 position, Vector2 size, Quaternion targetQuat, Color tint); // Draw a billboard texture with full 3D
